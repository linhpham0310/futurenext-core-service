...
export class InitializeAuthUserSchemaV11778487639590 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_8ae45196f82be4540770b41ac5" ON "auth_sessions" ("refresh_token_hash") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_email_verifications_lookup" ON "email_verifications" ("email", "consumed_at", "expires_at") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "idx_security_audit_logs_actor_id" ON "security_audit_logs" ("actor_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "user_consents" ADD CONSTRAINT "FK_6283f1222bdc2390cf16836ce7d" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_profiles" ADD CONSTRAINT "FK_b9627de400103265c502c57b56b" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_profiles" ADD CONSTRAINT "FK_44d2f6cb6cf5409bc5655771184" FOREIGN KEY ("reviewed_by_user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "security_audit_logs" ADD CONSTRAINT "FK_ad39fe26a9df23acc181563dca7" FOREIGN KEY ("actor_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "security_audit_logs" DROP CONSTRAINT "FK_ad39fe26a9df23acc181563dca7"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "teacher_profiles" DROP CONSTRAINT "FK_44d2f6cb6cf5409bc5655771184"`,
    );
    await queryRunner.query(
      `ALTER TABLE "teacher_profiles" DROP CONSTRAINT "FK_b9627de400103265c502c57b56b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "user_consents" DROP CONSTRAINT "FK_6283f1222bdc2390cf16836ce7d"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_security_audit_logs_created_at"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_security_audit_logs_action"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_security_audit_logs_actor_id"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_email_verifications_email"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_email_verifications_lookup"`,
    );
    await queryRunner.query(`DROP TABLE "email_verifications"`);
    await queryRunner.query(
      `DROP INDEX "public"."idx_teacher_profiles_status"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."idx_teacher_profiles_reviewed_by"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_8ae45196f82be4540770b41ac5"`,
    );
